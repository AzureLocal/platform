# azurelocal-platform — Agent instructions
...
Repo in the HCS estate managed under the platform engineering standard.
...
```
bootstrap(repo="azurelocal-platform", client="<your client: claude-code | codex | gemini | cursor | vscode>")
```
